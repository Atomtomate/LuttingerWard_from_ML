...
def main(args):
    ...
    for FC_layers in [3,5,6,7,8,9,10]:
        for FC_dim in [250]:
            if FC_layers == 6 and FC_dim == 200:
                ...
                model = AE_FC_02.load_from_checkpoint(checkpoint_path="G:/Codes/LuttingerWard_from_ML/.neptune/AE_FC_FCDimScale_with_dens/LWAEP-340/checkpoints/last.ckpt",config=config)
                ...
                trainer.fit(model, datamodule=dataMod, ckpt_path="G:/Codes/LuttingerWard_from_ML/.neptune/AE_FC_FCDimScale_with_dens/LWAEP-340/checkpoints/last.ckpt",)
