        ...
        for AE_layers in [2]:
            ...
            for laten_dims in [14,13,12,15,16]:
                if AE_layers == 2 and laten_dims == 14:
                    ...
                    model = AutoEncoder_02.load_from_checkpoint(checkpoint_path="G:/Codes/LuttingerWard_from_ML/.neptune/auto_encoder/LWAEP-418/checkpoints/last.ckpt",config=config)
                    ...
                    trainer.fit(model, datamodule=dataMod, ckpt_path="G:/Codes/LuttingerWard_from_ML/.neptune/auto_encoder/LWAEP-418/checkpoints/last.ckpt")
